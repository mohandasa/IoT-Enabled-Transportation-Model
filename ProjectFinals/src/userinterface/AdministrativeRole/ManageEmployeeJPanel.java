...
public class ManageEmployeeJPanel extends javax.swing.JPanel {
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        if (doesNotExist(organization, empName)&& Validators1.isValidString(empName)) {
            organization.getEmployeeDirectory().createEmployee(empName);
            populateTable(organization);
        } else {
            System.out.println("emp already added!");
   JOptionPane.showMessageDialog(null, "Employee already added or Please enter an employee name", "Employee Created",JOptionPane.INFORMATION_MESSAGE);
