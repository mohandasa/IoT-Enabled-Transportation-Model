...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(57, 57, 57)
                                .addComponent(createUserJButton, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        if (accountDoesNotExist(organization, employee)&&Validators1.isValidString(password)&&Validators1.isValidString(userName)) {
            organization.getUserAccountDirectory().createUserAccount(userName, password, employee, role);
            popData();
        } else {
            System.out.println("account already created!");
   JOptionPane.showMessageDialog(null, "Account already created or Please enter your username password", "Account Created",JOptionPane.INFORMATION_MESSAGE);

        }
    }//GEN-LAST:event_createUserJButtonActionPerformed

    private boolean accountDoesNotExist(Organization organization, Employee emp) {
        for (UserAccount acc: organization.getUserAccountDirectory().getUserAccountList()) {
            if (acc.getEmployee().getName().equalsIgnoreCase(emp.getName())) {
                return false;
            }
        }
        return true;
