...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if(enterprise.getUserAccountDirectory().checkIfUsernameIsUnique(username)&& Validators1.isValidString(name)&& Validators1.isValidString(username)&& Validators1.isValidString(password)){
   ...
   JOptionPane.showMessageDialog(null, "Please enter a username password", "EnterpriseAdmin",JOptionPane.INFORMATION_MESSAGE);
